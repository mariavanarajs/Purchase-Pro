...
class RndlotConversion extends BaseApiController
{
  ...
  public function saveendConversion(){
    ...
    $wheat_master = new RndlotConversionModel();

    $Wheat_ID = $wheat_master->master_mrc_wheat_varietyID($Data->CheckList->wheatvarietyid->value);
    $WheatID=$Wheat_ID[0]['Id'];
    $model = new RndlotConversionModel();
    $SublotDet = $model->getSublotlist_withPlant($Data,$WheatID);
