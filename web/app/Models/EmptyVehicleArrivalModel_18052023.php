...
class EmptyVehicleArrivalModel  extends BaseCgModel
{
  ...
  function isVehicleAlreadyIn ($record){
    ...
    $stts = [StatusConstant::$COMPLETED, StatusConstant::$PORT_DISPATCH, StatusConstant::$PORT_RECEIPT,StatusConstant::$MIGOAPPROVAL,StatusConstant::$MIGOCOMPLETED,StatusConstant::$REJECT_GATEOUT,StatusConstant::$REDIRECT];
