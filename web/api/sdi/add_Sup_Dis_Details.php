<?php
  ...
  */
  ...
  $file = $_FILES["files"]; 
  $filepath = upload_folder("supdis", SAP_FILE_PATH);
 ...
 // echo "DDD--";echo $last_id;exit;
  ...
  //echo $row3->sup_inv_Imgcopy;
    ...
    if(isset($row3->sup_wb_Imgcopy) && $row3->sup_wb_Imgcopy!="" && $sup_wb_copy=="" ){
      ...
      $sup_inv_copy_NAS = str_replace('/var/www/purchasepro/sapfileshare', 'https://purchasepro.nagamills.com/sapfileshare',$sup_inv_copy_NAS);
      $sup_wb_copy_NAS = str_replace('/var/www/purchasepro/sapfileshare', 'https://purchasepro.nagamills.com/sapfileshare',$sup_wb_copy_NAS);
    ...
    //  exit();
      ...
      if ($no_of_wagon) {
        for ($r = 0; $r < $no_of_wagon; $r++) {
          ...
          $sqlqc =
            "INSERT INTO purchase_info (ZVA_NUMBER, ZPO_NUMBER, ZSUPPLIER_CODE, ZSUPPLIER_NAME, TRUCK_NO, VECHICAL_STATUS, WERKS, IDNLF,INCO1,VEHICLE_TYPE, PO_LINE_ITEM,FNR_NO,SCREEN_TYPE,IsFromSDT ) VALUES ( '" .
            ...
            mysqli_real_escape_string($connect, trim($ZPO_LINE_ITEM)) .
            "','" .
            mysqli_real_escape_string($connect, trim($FNR_NO)) .
            "','" .
