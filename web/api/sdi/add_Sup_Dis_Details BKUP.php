...
$file = $_FILES["files"]; 
$filepath = upload_folder("supdis", "../api/upload");
//var_dump($_POST);exit();
...
if ($last_id) {
  ...
  foreach ($sdi_vehical_info as $row3) {
    ...
    $sql1 =
      ...
      "','" .
      mysqli_real_escape_string($connect, trim($sup_inv_copy)) .
      "','" .
      mysqli_real_escape_string($connect, trim($sup_wb_copy)) .
      "','" .
