...
curl_setopt_array($curl, array(
  ...
  CURLOPT_URL => ''.$SAP_HOSTNAME.'zwh_iaspo/iaspo?sap-client=900',
...
$Freight_Vendor=$Data[$i]->FREIGHT_VENDOR;
$Loading_Vendor=$Data[$i]->LOADING_VENDOR;
$Unloading_Vendor=$Data[$i]->UNLOADING_VENDOR;
...
if($Update_Flag=="I"){
 ...
 Freight_Charges,Loading_Charges,Unloading_Charges,loading_vendor,unloading_vendor,Freight_Vendor
        ) 
 ...
 $Qry="UPDATE `intrastate_sap_to_pp` SET `SendingPlant`='$SendingPlant', `materialno`='$materialno', `Segment`='$Segment', `WheatVariety`='$WheatVariety', `ReceivingPlant`='$ReceivingPlant', `ReceivingStorageLoc`='$ReceivingStorageLoc', `StoPoNo`='$StoPoNo', `PoNumber`='$PoNumber', `PoLineItem`='$PoLineItem', `PO_Quantity`='$PO_Quantity', `UOM`='$UOM', `Update_Flag`='$Update_Flag',`Freight_Charges`='$Freight_Charges',`Loading_Charges`='$Loading_Charges',`Unloading_Charges`='$Unloading_Charges',`loading_vendor`='$Loading_Vendor',`unloading_vendor`='$Unloading_Vendor',`Freight_Vendor`='$Freight_Vendor',`recstatus`='1', `ModDt`=current_timestamp, `PODt`=CURRENT_TIMESTAMP WHERE PoNumber='$PoNumber'";
  echo "<Br>".$Qry;
}
else
{
