...
if (mysqli_num_rows($result) > 0) {
    $fp = fopen('/var/www/purchasepro/sapfileshare/silo_to_mill/pp_sap_delivery_data/' . $date . 'pp_sap_delivery_data.csv', 'w');
