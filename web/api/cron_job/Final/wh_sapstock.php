...
//$Qry="UPDATE `ngw_sublot` SET WheatSAPQty=0";
$curl = curl_init();
curl_setopt_array($curl, array(
  // CURLOPT_URL => 'http://nfapplqua1.nagaltd.com:8001/zcomplaint/webcomplaint?sap-client=900',
  CURLOPT_URL => ''.$SAP_HOSTNAME.'warehouse/warehouse?sap-client=900',
...
$Qry="INSERT INTO `ngw_sublot`(`lotid`, `lotno`, `warehouseid`, `plantid`, `wheatvarietyid`, `wheatqty`,StorageLocationId,
                                SAP_Qty,WheatSAPQty,Keyloan_Release_Qty,Last_Keyloan_Pledge_Id,bagtypeid,lastfumigationdate,fumigationtypeid,
                    ...
                    VALUES ('".$LotId."','".$LotNumber."','".$WarehouseId."','".$PlantId."','".$WheatVarietyId."','".$Qty."',
                            '".$StorageLocationId."','0','0','0','0','1','1970-01-01','0','1970-01-01','1970-01-01','1970-01-01',
  ...
  if (floatval($Qty) <= floatval($WheatQty) || $last_fumigation_id == "0" ){
    ...
    $Qry="UPDATE `ngw_sublot` SET wheatqty='$Qty', SAP_Qty='$Qty',WheatSAPQty='$Qty' where sub_lot_id='$SublotId'";
  }else{
    $Qry="UPDATE `ngw_sublot` SET wheatqty='$Qty',WheatSAPQty='$Qty', SAP_Qty='".$Qty."', 
...
$UpdateAssign="UPDATE `ngw_sublot` SET SAP_Qty=WheatSAPQty,wheatqty=WheatSAPQty";
//$UpdateZero="UPDATE `ngw_sublot` SET WheatSAPQty=0";
$AssignIns=mysqli_query($connect,$UpdateAssign);
$UpdateZero="UPDATE `ngw_sublot` SET WheatSAPQty=0";
$InsertZero=mysqli_query($connect,$UpdateZero);
}
