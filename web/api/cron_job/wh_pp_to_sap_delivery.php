...
$query = "select 
    ...
    eva.WB_SERIAL_NO, eva.WB_EMPTY_WT, eva.TRUCK_NO, eva.WB_TICKET_NO, eva.WB_CHARGES, eva.SCREEN_TYPE, eva.VEHICLE_STATUS,
     ...
     intrad.ReceivingBin_id,intrad.ReceivingBin_Name, eva.tripsheet_no, eva.driver_name
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_URL => 'http://'.$SAP_HOSTNAME.'zwh_pp_sap/ias_data?sap-client=900',
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    //'Authorization: Basic bmFnYWFiYXA6TmFnYUA1NDMyMQ==',
...
function GetSAP_CSRF_Token()
{
  ...
  //exit();
  // exit();
  $TmpUrl = 'http://'.$SAP_HOSTNAME.'zwh_pp_sap/ias_data?sap-client=900';
  //echo "<br>".$TmpUrl."<br>";
$curl = curl_init();
curl_setopt_array($curl, array(
  //CURLOPT_URL => 'http://nfapplqua1.nagaltd.com:8001/zwh_iasdelivery/zwh_deliveryno?sap-client=900',
  CURLOPT_URL => $TmpUrl,
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
