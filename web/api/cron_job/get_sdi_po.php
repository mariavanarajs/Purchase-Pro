...
if ($handle = opendir("/home/nlsdp73/SAP/PP/openpos")) {
  while (false !== ($SAP_DATA = readdir($handle))) {
    if ($SAP_DATA != "." && $SAP_DATA != "..") {
      $target_file = "/home/nlsdp73/SAP/PP/openpos/" . $SAP_DATA;
      $new_target_location = "/home/nlsdp73/SAP/PP/openpos/archive/" . $SAP_DATA;
      //echo $target_file;
      $fileexists = 0;
  ...
  $Qry="UPDATE `pp_lastsynclog` SET  LastRunDate='$CurrentDateTime' where UniqueName='get_sdi_po_LastSyncDate'";
