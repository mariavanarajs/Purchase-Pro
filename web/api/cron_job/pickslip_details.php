...
//$date = date("YmdHis");
if ($handle = opendir("/home/nlsdp73/SAP/PP/ias/pickslip_details")) {

    while (false !== ($SAP_DATA = readdir($handle))) {
        if ($SAP_DATA != "." && $SAP_DATA != "..") {
            if ($SAP_DATA != "archive") {
                $target_file = '/home/nlsdp73/SAP/PP/ias/pickslip_details/' . $SAP_DATA;
                $new_target_location = "/home/nlsdp73/SAP/PP/ias/pickslip_details/archive/" . $SAP_DATA;
