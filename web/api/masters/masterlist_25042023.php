...
function GetUser_infolist($connect,$record){
  ...
  $fetchsql = "SELECT a.`UI_ID`, a.`FIRST_NAME`, a.`LOGIN_ID`, a.`SI_NO`, a.`DESIGNATION`,c.ROLE_NAME, a.`DEPARTMENT`, a.`CITY`, a.`STATE`, a.`USER_ROLE_ID`, a.`USER_STATUS`,b.label ACTIVELABEL, a.`InsBy`, a.`InsDt`, a.`ModBy`, a.`ModDt`, a.`RecStatus`
