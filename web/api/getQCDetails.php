...
$server = '192.168.1.44' ;//Address of ftp server
$user_name = 'HRMS'; // Username
$password = 'AdminProfit@1'; // Password
...
exit();
$location ="Siloqc/PP/Foss/Wheat Naga_2021-10-06_18-00-01.csv"; 
$local=basename("Wheat Naga_2021-10-06_18-00-01.csv");
var_dump(ftp_get($connection, $local,$location, FTP_BINARY));
