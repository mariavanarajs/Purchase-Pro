...
function fetch_IASDetails($connect, $record)
{
  ...
  $Id=$record->id;
    ...
    $fetchsql =
    "SELECT a.ID as PI_REFID,a.VEHICLE_STATUS as VECHICAL_STATUS,a.ZVA_NUMBER,b.StatusName,a.CHANGE_VECHICAL_STATUS
...
function fetchSDO_SDIDetails($connect, $record)
{
  ...
  $Id=$record->id;
    ...
    $fetchsql =
    "SELECT a.PI_REFID,a.VECHICAL_STATUS,a.ZVA_NUMBER,b.StatusName,a.CHANGE_VECHICAL_STATUS
