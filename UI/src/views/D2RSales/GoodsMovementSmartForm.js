                                ...
                                <tbody>
                                    <tr>
                                        <td style={{ padding: "5px" }}><table style={{ width: "100%" }} border={0}>
                                            ...
                                            <tr style={trstyle}><td colSpan={6} style={subheadingstyle1}><strong>GoodsMovement SmartForm</strong></td></tr>
                                            <tr><td colSpan={6}><hr></hr></td></tr>
...
export default GoodsMovementSmartForm