...
const Master_to_locationlist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_to_locationlist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_to_locationlist;
