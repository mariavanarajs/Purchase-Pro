...
const Master_wheat_varietylist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_wheat_varietylist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_wheat_varietylist;
