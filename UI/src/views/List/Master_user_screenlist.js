...
const Master_user_screenlist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_user_screenlist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_user_screenlist;
