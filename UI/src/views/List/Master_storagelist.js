...
const Master_storagelist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_storagelist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_storagelist;
