...
const Master_port_of_loadinglist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_port_of_loadinglist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_port_of_loadinglist;
