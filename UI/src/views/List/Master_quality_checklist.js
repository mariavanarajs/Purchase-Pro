...
const Master_quality_checklist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_QC_WheatVariety" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_quality_checklist;
