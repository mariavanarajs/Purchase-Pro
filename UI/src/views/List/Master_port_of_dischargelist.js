...
const Master_port_of_dischargelist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_port_of_dischargelist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_port_of_dischargelist;
