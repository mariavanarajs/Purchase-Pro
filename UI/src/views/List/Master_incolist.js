...
export const taColumns = [
  ...
  {
    name: "INCO Description",
    selector: "INCO_DESC",
    sortable: true,
    minWidth: "150px",
  },
];
const Master_incolist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_incolist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_incolist;
