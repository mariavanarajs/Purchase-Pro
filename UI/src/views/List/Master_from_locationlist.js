...
const Master_from_locationlist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody s>
          <TableComponent columns={columns} url={url} formType="Getmaster_locationlist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_from_locationlist;
