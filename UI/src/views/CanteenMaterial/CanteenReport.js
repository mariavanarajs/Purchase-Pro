...
import { Col ,FormGroup, Label,Button, ButtonToggle, Badge } from 'reactstrap'
...
const CanteenReport = ({})  => { 
  ...
  const taColumns = [
            ...
            return (
                <Col sm="12" md="12">
                    <FormGroup className="d-flex justify-content-center mb-0">
                        {row.completed_status == 0 &&
                        <Badge color="danger" pill>
                            {row.status}
                        </Badge> }
                        {row.completed_status == 1  &&
                        <Badge color="info" pill>
                            {row.status}
                        </Badge> }
                        {row.completed_status == 2  &&
                        <Badge color="info" pill>
                            {row.status}
                        </Badge> }
                        {row.completed_status == 3  &&
    ...
    const getLoadUnloadList = () => {
     ...
     showLoader();
    //  apiPostMethod(apiBaseUrl + "GatePro/Gate/getCanteenReport")
    apiPostMethod(apiBaseUrl + `GatePro/Gate/getCanteenReport/${fromDateMilliSecond}/${toDateMilliSecond}/${moduleType}/${UserDetails.USERID}`)
     .then((response) => {
       const { data } = response;
 ...
 //Modal pop up window 
  ...
  return ( 
    <Fragment>
    <RefreshBlock/>
     <CardComponent  header="Canteen Material Report">
     <Row>
                        <Col md="3" sm="3">
      ...
      <Modal show={open} centered size="xl">
        <Modal.Header><b>Canteen Material Report</b>
            ...
            <Modal.Body>
                <Row>
                   ...
                   <Col md="4" sm="12">
                    ...
                    <Col md="4" sm="12">
                      <CustomTextInput label={"Invoice Date"} form={form} id="overall_tonnage" value = {Data1?.invoiceDate} type="text" disabled/>
                    </Col>
                    <Col md="4" sm="12">
                    ...
                    <Col md="4" sm="12">
                      <CustomTextInput label={"Remarks"} form={form} id="remarks" value = {Data1?.remark} type="text" disabled/>
                    </Col>
                </Row>
                <Row>
                  {/* <Col align="left">
