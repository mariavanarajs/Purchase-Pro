...
const smartFormHeaderRake = ({data}) => {
    console.log(data)
    return (
        <>
            <br></br><br></br>
                            ...
                            <tr>
                                ...
                                <td style={{ textAlign: "center" }}>
                                    ...
                                    <span style={{ fontSize: "13px" }}>Branch/Depot:{data.companyName1},{data.address3},{data.address2} :{data.pinCode}, <br></br>
                                      GSTIN:{data.gstInNumber},PAN:{data.panNumber},CIN:{data.cinNumber},<br></br>
                                      </span>

                                </td>
                                <td style={{ textAlign: "right" }}>
                                    <img style={{ width: "150px", height: "auto", marginBottom: "-23px" }} src={BASE_URL + "/api/upload/images/Logo2.png"}></img>
                                </td></tr>
                        </table>
                    </td>
                </tr>
...
export default smartFormHeaderRake
