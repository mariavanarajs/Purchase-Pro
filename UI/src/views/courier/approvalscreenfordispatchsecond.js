...
const ConsignmentPaymentInitiate = ({ title, url, actionRenderer }) => {
  ...
  const loadTableData = async () => {
    ...
    showLoader();
    try {
      const response = await apiPostMethod(apiBaseUrl + "CourierMaster/getpaymentdetails2", postdata);
      const { data } = response;
  ...
  const handleApproveConfirmation = async (row) => {
    ...
    try {
      const response = await apiPostMethod(apiBaseUrl + "CourierMaster/approveCourierItem2", postdata);
      const { data } = response;
  ...
  const handleRejectConfirmation = async (row) => {
    ...
    showLoader();
    try {
      const response = await apiPostMethod(apiBaseUrl + "CourierMaster/rejectCourierItem2", postdata);
      const { data } = response;
