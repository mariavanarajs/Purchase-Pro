...
const IASListTable = ({ isTruck,title, actionCell, postData, hideFilter, actitionColumnWidth,ScreenName }) => {
  let options = [
  ...
  if (actionCell) {
    ...
    columns = [...evaColumns(isTruck),, actionsCol];
  } else {
    columns = [...evaColumns(isTruck),];
  }
  return (
    <div>
      <Card>
