...
const RMWaterSmartForm = () => {
    ...
    const getPurchaseOrder = (loadingUnloadingInfoId) => {
        ...
        apiGetMethod(apiBaseUrl + `GatePro/Master/getPurchaseOrder/${loadingUnloadingInfoId}`)
            .then((response) => {
                const { data } = response;
                if (data.success == true) {
                                        ...
                                        <td style={{ padding: "5px" }}><table style={{ width: "100%" }} border={0}>
                                            ...
                                            {poData.map((poDetails) => (<>
                                                <tr style={trstyle}>
                                                    ...
                                                    <td><strong>Vendor Code :</strong></td><td>{poDetails?.vendorCode}</td>
...
export default RMWaterSmartForm