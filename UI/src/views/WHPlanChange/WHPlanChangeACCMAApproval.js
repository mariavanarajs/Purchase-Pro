...
const WHPlanChangeACCMAApproval = () => {
  ...
  const tabs = [
    ...
    },
    {
      id: "relotting",
      title: "RELOTTING",
      renderTab: () => <RelottView  formTypes = {"getRelottingProcessChangeWHACCMG"}/>,
    },
  ];
  ...
  return (
    ...
    <div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Entry Rejected Accounts Manager </CardTitle>
          {/* <NavItem>
...
export default WHPlanChangeACCMAApproval;
