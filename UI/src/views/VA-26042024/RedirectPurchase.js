...
import { Row, Col, Button, Label, FormGroup, Input, Card, CardHeader, CardBody, Alert } from "reactstrap";
...
const RedirectPurchase = () => {
                ...
                if (data.success == true) {
                    ...
                    apiPostMethod(apiBaseUrl + "LandingDataController/GatePass_DocumentVerify", postData)
                        .then((response) => {
                            ...
                            if (data.success == true) {
                                if (type == 'GET') {
                                    setRedirectPlant(data.results[0].SAP_LINE[0].REC_PLANT || data.results[0].VENDOR_PLANT)
                                    setRedirectData(data.results)
                                    getMasterPlant(data.results[0].SAP_LINE[0].REC_PLANT || data.results[0].VENDOR_PLANT)
                                }
    ...
    const redirectVehicle = () => {
        ...
        const postdata = {
            ...
            isRedirect: 1,
            redirectMasterPlantId: checkMasterPlant != '' ? checkMasterPlant : '',
            ...
            <Card>
                ...
                <CardBody>
                    <Row>
                        ...
                        {redirectPlant != '' && data.firstWeight != null ?
                            <Col sm="2" md="2">
                                <label>&nbsp;</label>
