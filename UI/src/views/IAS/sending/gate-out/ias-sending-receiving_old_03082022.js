...
import { apiBaseUrl, BASE_URL, SaveCaptureImage, uploadandSaveImageUrl } from "../../../../urlConstants";
    ...
    if (emptyArrivalId) {
      ...
      Promise.all([
        ...
        .then((response) => {
          ...
          console.log("response : ", disData.data.results);
