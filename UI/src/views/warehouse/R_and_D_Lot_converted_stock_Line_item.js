...
const  R_and_D_Lot_converted_stock_Line_item = ({form,onSubmit}) =>{
   ...
   setWheatvarietyoption({ ...stockEntryformData, WheatVarietyid:value, WheatVariety:label }); 
    ...
    return (
        <Fragment> 
             <Row >
                 <Col md="3" sm="12">
                 <CustomTextInput label={"From Date"} form={form} id="Date" type="Date" />
                 </Col>
                 <Col md="3" sm="12">
                 <CustomTextInput label={"To Date"} form={form} id="Date" type="Date" />
                 </Col>
                 <Col md="3" sm="12"> 
         ...
         <Button.Ripple color ="primary"  type="Button" >Export Download</Button.Ripple> 
         </div>
         </div>  
         <div className=''>
                   ...
                   <div style={{minWidth:"100wv",overflow:"scroll",minHeight:"30vh"}}>
                  <table className='table-sm'  >
                    <thead className='bg-primary text-white' style={{height:"50px",textAlign:"center"}}>
                      <tr>
                        <th style={{minWidth:"100px"}}>QA No</th> 
                        <th style={{minWidth:"100px"}}>Lot No</th> 
                        <th style={{minWidth:"100px"}}>QA Date</th> 
                        <th style={{minWidth:"120px"}}>Wheat Variety</th>
                        <th style={{minWidth:"120px"}}>Stock in MTS</th> 
                        <th style={{minWidth:"70px"}}>P1</th>  
                        <th style={{minWidth:"70px"}}>P2</th> 
                        <th style={{minWidth:"70px"}}>P3</th>  
                        <th style={{minWidth:"70px"}}>P4</th> 
                        <th style={{minWidth:"70px"}}>P5</th>  
                        <th style={{minWidth:"70px"}}>P6</th> 
                        <th style={{minWidth:"70px"}}>P7</th>  
                        <th style={{minWidth:"70px"}}>P8</th> 
                        <th style={{minWidth:"70px"}}>P9</th>  
                        <th style={{minWidth:"70px"}}>P10</th> 
                        <th style={{minWidth:"70px"}}>P11</th>  
                        <th style={{minWidth:"70px"}}>P12</th> 
                        <th style={{minWidth:"70px"}}>P13</th>  
                        <th style={{minWidth:"70px"}}>P14</th> 
                        <th style={{minWidth:"70px"}}>P15</th>  
                        <th style={{minWidth:"70px"}}>P16</th> 
                        <th style={{minWidth:"70px"}}>P17</th>  
                        <th style={{minWidth:"70px"}}>P18</th> 
                        <th style={{minWidth:"70px"}}>P19</th>  
                        <th style={{minWidth:"70px"}}>P20</th> 
                        <th style={{minWidth:"70px"}}>P21</th>  
                        <th style={{minWidth:"70px"}}>P22</th> 
                        <th style={{minWidth:"70px"}}>P23</th>  
                        <th style={{minWidth:"70px"}}>P24</th> 
                        <th style={{minWidth:"70px"}}>P25</th>  
                        <th style={{minWidth:"70px"}}>P26</th> 
                        <th style={{minWidth:"70px"}}>P27</th>  
                        <th style={{minWidth:"70px"}}>P28</th> 
                        <th style={{minWidth:"70px"}}>P29</th>  
                        <th style={{minWidth:"70px"}}>P30</th> 
                        <th style={{minWidth:"70px"}}>P31</th>  
                        <th style={{minWidth:"70px"}}>P32</th> 
                        <th style={{minWidth:"120px"}}>Veiw R&D</th>
                      </tr>
                    </thead> 
                    <tbody style={{textAlign:"center"}}>
                      <tr>
                        ...
                        <td></td>
                        <td> </td> 
                        <td><Button.Ripple color="success" type="Button" >Green</Button.Ripple></td>
                      </tr>
                    </tbody>
                  </table> 
                  </div>
...
const  R_and_D_Lot_converted_stock_Line_itemData = ()  => {
    const history = useHistory();
    ...
    return (
        <Fragment>
             <CardComponent  header="R & D Lot converted stock Line item">
            < R_and_D_Lot_converted_stock_Line_item  form={form}  onSubmit={onSubmit}  />
             </CardComponent>         
              </Fragment>
    )
}

export default  R_and_D_Lot_converted_stock_Line_itemData
