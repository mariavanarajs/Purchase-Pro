...
const FumigationViewHistory = ({form})  => { 
...
const gotoFumigationTeam= () =>{
  history.push("/warehouse/FumigationViewHistory");
}
const gotoDegasQC= () =>{
...
<div style={{Width:"970px",minHeight:"400px",fontSize:"13px",overflowX:"auto"}} >
...
const FumigationViewHistoryData = () => { 
  const history = useHistory();
...
approvestatus:formData.approvestatus.value,
    ...
    return(
        <Fragment>
        <CardComponent  header="Fumigation View History">
       <FumigationViewHistory form={form}  onSubmit={onSubmit}  />
     </CardComponent>
      </Fragment>
    )
...
export default FumigationViewHistoryData 
