          ...
          for(let i=0;i<data.results.length;i++){
            if(data.results[i].planid!=refid){
              NewData={
                ...
                WareHouse:data.results[i].WareHouse,
                fromwarehouseid:data.results[i].WareHouse,
  ...
  // console.log(postdata);
    ...
    apiPostMethod(apiBaseUrl + "Warehouse/STOPODeliveryPlan/AddUpdateSTOPODeliveryPlan", postdata)
      ...
      //  alert("4");
        ...
        history.push(`/warehouse/WheatmvmntgdntogdnApproval`);
      ...
      <Table className='table-sm mt-2' style={{width:"160%", sortable: true} } >
        ...
        <thead>
          ...
          <th style={{verticalAlign:"middle",backgroundColor:"#7367f0",color:"#fff", textTransform:"none",fontWeight:"500",fontSize:"12px"}  }  className="custom-width">Valid From</th>
            ...
            <th style={{verticalAlign:"middle",backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500",fontSize:"12px"}} className="custom-width">Approve</th>
            <th style={{verticalAlign:"middle",backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500",fontSize:"12px"}} className="custom-width">Reject</th>
            ...
            return(
              <tr>
                ...
                <td><Button.Ripple 
                      color="primary" 
                      type="button"  
                      onClick={(e) => onSubmit(2,item.planid)}>
                      Approve
                    </Button.Ripple>
                </td>
                <td><Button.Ripple 
                      color="primary" 
                      type="button" 
                      onClick={(e) => onSubmit(-1,item.planid)}>
                      Reject
                    </Button.Ripple>
                </td>
              </tr>
...
const STOPOGTGDeliveryCreationApproval = () => {
  ...
  return (
    <Fragment >
      ...
      <CardComponent header="Wheat Movement Godown to Godown - Approval" >
      <RefreshBlock />
...
export default STOPOGTGDeliveryCreationApproval;
