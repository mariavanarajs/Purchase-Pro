...
const FumigationSkipReport = ({form,onSubmit,ImgData,setImgData}) => { 
    ...
    const ActionEntry = (sub_lot_id,index,Status) => {
      ...
      const postdata = {
        id:sub_lot_id,
        ScreenType:'FUMIGATIONSKIPREPORT',
        Data
      }
 ...
 const FillPlantList  = (warehouseid, whname) => {
  ...
  .then((response) => {
    ...
    if(data.success) {
      ...
      form.setFieldValue('warehouseid', {  label: whname,value: warehouseid });
    ...
    return (
      <Fragment>
        ...
        <thead className='bg-primary text-white ' style={{height:"50px",textAlign:"center"}}> 
             ...
             <th style={{minWidth:"200px"}}>Qty</th>
             <th style={{minWidth:"200px"}}>Created_At</th>
             <th style={{minWidth:"200px"}}>SkipDate</th>
...
const FumigationSkipReportData = () => { 
    const history = useHistory();
...
return (
    <Fragment>
      ...
      <CardComponent  header="Fumigation Skip Report"> 
        
     <FumigationSkipReport form={form}  onSubmit={onSubmit}  ImgData={ImgData} setImgData={setImgData}  />
...
export default FumigationSkipReportData
