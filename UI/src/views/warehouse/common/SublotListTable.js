...
import { tblSublotlistUrl } from "../../../urlConstants";
import TableComponent from "../../../views/common/TableComponent";
import { taColumns, status } from "./appHelper";

import Select from "react-select";

const SublotListTable = ({ title, actionCell, postData, hideFilter, actitionColumnWidth,ScreenName }) => {
...
export default SublotListTable;
