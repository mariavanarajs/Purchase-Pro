...
////import STOPODeliveryCreationApprovalEditForm from "./STOPODeliveryCreationApprovalEditForm";
import { Row, Col,Button,Table,FormGroup } from "reactstrap";
import { Link } from "react-router-dom";
import { CustomDropdownInput, CustomTextInput } from "../forms/custom-form";
import Select from "react-select";

const STOPODeliveryCreationApprovalEditForm = ({ form }) => {
...
KeyLoanDOQty:data.results[0].Unpledgeqty
  ...
  return (
    <Fragment >
      ...
      <Table className='table-sm' style={{display:"none"}}>
        <tbody>
      <tr>
        <td style={{minWidth:"200px"}} >
         {/* <CustomDropdownInput 
          url={`${apiBaseUrl}warehouse/master/getWeekNo`} style={{zIndex:'1000'}} label={"Week"} 
          form={form} id="WeekNo" />
         */}
         <CustomTextInput  label={"Week"} disabled form={form} id="WeekNoName" type="text"
          />
        ...
        />*/}
         <CustomTextInput  label={"WH.Name"} disabled form={form} id="WareHouseName" type="text"
          />
       ...
       />*/}
        <CustomTextInput  label={"Storage Location"} disabled form={form} id="PlantName" type="text"
          />
        </td>
        <td  style={{minWidth:"200px"}}>
          {/*<Select 
          ...
          />*/}
           <CustomTextInput  label={"Lot Number"} disabled form={form} id="LotNumberName" type="text"
          />
        ...
        />*/}
         <CustomTextInput  label={"Wheat Varity"} disabled form={form} id="WheatVarityName" type="text"
          />
        <span id='WheatVariety_Error' style={{color: 'red'}} ></span>
          ...
          <td style={{minWidth:"200px"}}>
          <CustomTextInput   label={"R&D Qty"} disabled form={form} id="RandDConfirmedQty" type="text"  isNumberOnly decimalFormat="10,0"/>
          <span id='RandDConfirmedQty_Error' style={{color: 'red'}} ></span>

          </td>

          <td style={{minWidth:"200px"}}>
          <CustomTextInput  label={"Fumigation Cl.Qty"} disabled form={form} id="FumigationClearedQty" type="text"  isNumberOnly decimalFormat="10,0"/>
    ...
    onChange={(e) => OnChangeMovementQty(e)}      
          MinNumberVal={form.values.MinNumberQty ? form.values.MinNumberQty: "-1"} type="text" 
           isNumberOnly decimalFormat="10,0"/>
          <span id='MovementQty_Error' style={{color: 'red'}} ></span>

          </td>
           <td  style={{minWidth:"200px",display:"none"}}>
          <CustomTextInput  label={"Mixing Ratio"} form={form} id="MixingRatio"
           type="text" 
           onChange={(e) => getActualQty(e)}
           isNumberOnly decimalFormat="10,0"/>

          <span id='MixingRatio_Error' style={{color: 'red'}} ></span>
          </td>
          <td  style={{minWidth:"200px"}}>
          <CustomTextInput label={"Act.Movement Qty"} disabled form={form} id="ActualMovementQty" type="text"  isNumberOnly decimalFormat="10,0"/>
          <span id='ActualMovementQty_Error' style={{color: 'red'}} ></span>

          </td>
         
          <td  style={{minWidth:"200px"}}>
          <CustomTextInput label={"Valid From"} form={form} id="ValidFrom" type="date"  />
       ...
       {/*<CustomDropdownInput  url={`${apiBaseUrl}warehouse/master/getRestrictMode`} label={"Restrict Mode"} form={form} id="RestrictMode" />
       */}
       <CustomTextInput  label={"Restrict Mode"} disabled form={form} id="RestrictModeName" type="text"
          />
        <span id='RestrictMode_Error' style={{color: 'red'}} ></span>
        </td>
      ...
      <Row>
      <Col md="12" sm="12">
      <Table className='table-sm mt-2' style={{width:"300%"}} >

                      <thead>
                        <tr>
                          {/*<th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Edit</th>*/}
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500",width:"200px"}} className="custom-width">Movement Group No</th>
                          ...
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Actual Qty</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">R & D Confirmed Qty</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Fumigation Cleared Qty</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Keyloan DO Qty</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Movement Qty</th>
                          
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Valid From</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Valid To</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Week</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Restrict</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Receiving Bin</th>
                          <th style={{backgroundColor:"#7367f0",color:"#fff",textTransform:"none",fontWeight:"500"}} className="custom-width">Delete</th>
                        </tr>
                      </thead>
                      <tbody>
                      {PlanDatas &&
          ...
          >
            ...
            <span className="align-middle ml-25">Edit</span>
               ...
               <td>{item.MovementGroupNumber}</td>
...
<td style={{color:item.RndSkipFlag==1 ?"blue" :"green"}}>{item.RandDConfirmedQty}</td>
<td  style={{color:item.FumigationSkipFlag==1 ?"blue" :"green"}}>{item.FumigationClearedQty}</td>
<td style={{color:"green"}}>{item.KeyLoanDOQty}</td>
<td>{item.MovementQty}</td>

<td style={{display:"none"}}>{item.MixingRatio}</td>

<td style={{display:"none"}}>{item.ActualMovementQty}</td>
<td>{item.ValidFrom}</td>
<td>{item.ValidTo}</td>
<td>{item.WeekNoName}</td>

<td>{item.RestrictMode}</td>
<td>{item.ReceivingBinName}</td>
 <td><Button.Ripple
      ...
      <Col sm="12">
              ...
              <Button.Ripple outline color="secondary" tag={Link} to={`/warehouse/STOPODeliveryCreationApproval`} type="reset" className="mr-2">
                  Cancel
                </Button.Ripple>
      <Button.Ripple color="primary" type="button" disabled={AddValue()} onClick={(e) => onSubmit(2)}>
               Approve
              </Button.Ripple>
              &nbsp;
               
              <Button.Ripple color="primary" type="button" onClick={(e) => onSubmit(3)}>
              Reject
              </Button.Ripple>
              &nbsp;
              <CustomTextInput placeholder="Reject Reason"  form={form} id="RejectReason" type="text"
          />
              </FormGroup>
...
const STOPODeliveryCreationApprovalEdit = () => {
  ...
  return (
    <Fragment >
      ...
      <CardComponent header="Wheat Movement Weekly Plan Approval" >
      <RefreshBlock />
        <div style={{overflowY:'auto',overflowX:'auto',maxWidth:'100vw',minHeight:'450px'}}>
        <STOPODeliveryCreationApprovalEditForm form={form}  />
        </div>
      </CardComponent>
...
export default STOPODeliveryCreationApprovalEdit;
