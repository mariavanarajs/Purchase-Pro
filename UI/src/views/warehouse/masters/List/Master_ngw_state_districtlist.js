...
const Master_ngw_state_districtlist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_ngw_state_districtlist" />
        </CardBody>
      </Card>
    </div>
  );
};
export default Master_ngw_state_districtlist;
