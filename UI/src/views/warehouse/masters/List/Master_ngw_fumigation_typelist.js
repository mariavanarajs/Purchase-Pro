...
const Master_ngw_fumigation_typelist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_ngw_fumigation_typelist" />
        </CardBody>
      </Card>
    </div>
  );
...
export default Master_ngw_fumigation_typelist;
