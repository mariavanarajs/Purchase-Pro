...
const Master_ngw_banklist = ({ title, url, actionRendorer }) => {
  ...
  return (
    <div>
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="GetMaster_ngw_banklist" />
        </CardBody>
      </Card>
    </div>
  );
};
export default Master_ngw_banklist;
