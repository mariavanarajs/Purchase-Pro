...
const WarehouseCreationQCList = () => {
  ...
  let title="Warehouse Creation - Quality Team List";
  console.log(title);
  ...
  let actionRendorer=(row) => {
    ...
    let tx = "View";
          ...
          if(row.approval_status==2 || row.approval_status==102)
          {
            tx="QC Entry";
          }
      ...
      <Button.Ripple
        ...
        onClick={() => {
          ...
          else if(row.approval_status==2 || row.approval_status==102 || row.approval_status==-2)
          {
  ...
  return (
      ...
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="WarehouseCreationQCList" />
        </CardBody>
      </Card>
    </div>
    </Fragment>
