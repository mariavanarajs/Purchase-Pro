...
import { Plan_Report_ApprovalScreen } from "./../WarehouseDropdownList";
...
const filter_Id={
  ...
  division_id:"",
  division_Name:"",
  screenType:"RND_SCREEN",
}

const Plan_ApprovalScreenData = ({ form }) => {
            ...
            return( 
              <Row> 
                <Col>
                  ...
                  <Plan_Report_ApprovalScreen
                    title={'Plan_Report_ApprovalScreen'}
                    screenType="APPROVAL_SCREEN" 
                    form={form}
...
const Plan_ApprovalScreen = () => {
  ...
  return (
    <Fragment >
      ...
      <CardComponent header="Plan Approval Screen - Report" >    
       <RefreshBlock /> 
     
        {/* <div style={{overflowY:'auto',overflowX:'auto',maxWidth:'100vw',minHeight:'450px'}}> */}
        <Plan_ApprovalScreenData form={form}  />
        {/* </div> */}
      </CardComponent>
...
export default Plan_ApprovalScreen;
