...
import { Rnd_Confirmation_Plan, Plan_Testing } from "./../WarehouseDropdownList";
...
const R_and_D_ConfirmationData = ({ form }) => {
            ...
            return( 
              <Row> 
                <Col>
                  ...
                  <Rnd_Confirmation_Plan
                    title={'Rnd_Confirmation_Plan'}
...
const R_and_D_Confirmation = () => {
  ...
  return (
    <Fragment >
      ...
      <CardComponent header="Plan R & D Confirmation" >    
       <RefreshBlock /> 
     
        {/* <div style={{overflowY:'auto',overflowX:'auto',maxWidth:'100vw',minHeight:'450px'}}> */}
        <R_and_D_ConfirmationData form={form}  />
        {/* </div> */}
      </CardComponent>
...
export default R_and_D_Confirmation;
