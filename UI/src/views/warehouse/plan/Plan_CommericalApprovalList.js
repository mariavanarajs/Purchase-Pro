...
export const CommericalApprovalLists = ({ title, url, actionRendorer, postData, screenType, ...rest }) => {
  ...
  const handleShowModal =(WarehouseId)=>{
    ...
    return (
      <div >     
        ...
        <Card>
          <CardHeader>
            <CardTitle>{"Commerical Approval Month one"}</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="CommericalApproval_one" {...rest}/>
          </CardBody>
        </Card>  
...
<div style={{border:"2px solid #7367f0 ",padding:"2px",borderRadius:"6px",marginTop:"12px"}}>  
        <Card>
          <CardHeader>
            <CardTitle>{" Commerical Approval Month Two" }</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="CommericalApproval_Two" {...rest}/>
          </CardBody>
        </Card> 
...
{/* month Three */}
          <div style={{border:"2px solid #7367f0 ",padding:"2px",borderRadius:"6px",marginTop:"12px"}}>  
            <Card>
          <CardHeader>
            <CardTitle>{" Commerical Approval Month Three"}</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="CommericalApproval_Three" {...rest}   
          /> 
...
<div style={{border:"2px solid #7367f0 ",padding:"2px",borderRadius:"6px",marginTop:"12px"}}>  
            <Card>
          <CardHeader>
            <CardTitle>{" Commerical Approval Month four"}</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="CommericalApproval_Four" {...rest}/>
          </CardBody>
        </Card> 
...
export const CommericalApprovalList  = ({ form }) => {
  const history = useHistory();
