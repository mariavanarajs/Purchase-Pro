...
//   },
  {
    name: "Priority(Entry Option Needed)",
    selector: "PlanMonth",
    sortable: true,
    minWidth: "250px", 
...
export const Plan_R_and_D_Confirmationlists = ({ title, url, actionRendorer, postData, screenType, ...rest }) => {
  ...
  const handleShowModal =(WarehouseId)=>{
    ...
    return (
      <div >     
          <div style={{border:"2px solid #7367f0 ",padding:"2px",borderRadius:"6px",marginTop:"5px"}}>  
        <Card>
          <CardHeader>
            <CardTitle>{"Plan R & D Confirmation Month one"}</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="plan_R_and_D_Confirmation_list_one" {...rest}/>
          </CardBody>
        </Card>  
        ...
        <div class="d-flex justify-content-center align-items-center">  
                  <div class="mx-5">
                  <Button.Ripple color="primary" type="button"  disabled={AddValue()} onClick={(e) => onSubmit(2)}>Approve </Button.Ripple>
                  </div>  
                  <div class="mx-1">

             
            <Button.Ripple color="primary" type="button" onClick={(e) => onSubmit(3)}>Reject</Button.Ripple>
            </div> 
            <div>
            <CustomTextInput placeholder="Reject Reason" style={{width:"230px"}} form={form} id="RejectReason" type="textarea"   /> 
            </div>
                  </div>    
                  </div>
...
<div style={{border:"2px solid #7367f0 ",padding:"2px",borderRadius:"6px",marginTop:"12px"}}>  
        <Card>
          <CardHeader>
            <CardTitle>{"Plan R & D Confirmation Month Two" }</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="plan_R_and_D_Confirmation_list_two" {...rest}/>
          </CardBody>
        </Card> 
...
{/* month Three */}
          <div style={{border:"2px solid #7367f0 ",padding:"2px",borderRadius:"6px",marginTop:"12px"}}>  
            <Card>
          <CardHeader>
            <CardTitle>{"Plan R & D Confirmation Month Three"}</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="plan_R_and_D_Confirmation_list_three" {...rest}   
          /> 
...
<div style={{border:"2px solid #7367f0 ",padding:"2px",borderRadius:"6px",marginTop:"12px"}}>  
            <Card>
          <CardHeader>
            <CardTitle>{"Plan R & D Confirmation Month four"}</CardTitle>
          </CardHeader>
          <CardBody>
            <TableComponent columns={columns} postData={postData} url={url} formType="plan_R_and_D_Confirmation_list_four" {...rest}/>
          </CardBody>
        </Card> 
...
export const Plan_R_and_D_Confirmation_list = ({ form }) => {
  const history = useHistory();
