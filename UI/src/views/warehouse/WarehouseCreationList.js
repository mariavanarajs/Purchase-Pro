...
const WarehouseCreationList = () => {
  
  let title="Warehouse Approval List Screen";
  console.log(title);
  ...
  return (
    <Fragment>
      ...
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="WarehouseCreationList" />
        </CardBody>
      </Card>
    </div>
    </Fragment>
...
export default WarehouseCreationList;
