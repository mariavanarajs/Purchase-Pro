...
const WarehouseLotInformationMgrApprove = ({form,onSubmit}) => {
  ...
  // return false;
    ...
    const isFilledAll = () => {
      ...
      showError('Storage_Location_Error','Enter Storage Location',0);
    ...
    if(FileSaveUrl==""){
      ...
      .then((response) => {
        if (response.data.success) {
          history.push(`/warehouse/WarehouseLotInformationMgrApprove`);
          window.location.reload();
        }
      })
      .catch((error) => {
       ...
       <Fragment>  
         ...
         <div class="d-flex justify-content-between pb-1">
            ...
            <div style={{height:"auto",width:"100%",overflow:"auto"}}>
             <table class="table-sm" border={0} style={{overflow:"scroll", minWidth:"97vw", minHeight:"40vh", fontSize:"13px", textAlign:"left"}}>
            <thead class="bg-primary text-white">
            <tr>
            <th style={{minWidth:"130px"}}>Warehouse Name</th>
            <th style={{minWidth:"100px"}}>Plant Name</th>
...
const WarehouseLotInformationMgrApproveData = () => { 
    const history = useHistory();
    ...
    return (
     ...
     <WarehouseLotInformationMgrApprove  form={form}  onSubmit={onSubmit}  />
   </CardComponent>
...
export default WarehouseLotInformationMgrApproveData
