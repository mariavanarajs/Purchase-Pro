...
import { ToggleLeft, Upload } from 'react-feather';
    ...
    return (
        <Fragment style={{minWidth:"1000px"}}>  
           ...
           <Col md="2" sm="12"> 
                ...
                <CustomTextInput label={"Count of weigh Bridge"} form={form} id="wb_count" disabled type="text"  /> 
                    ...
                    <span id="wb1_stamping_expiry_date_Error" style={{color: "red"}} ></span> 
                      ...
                      onClick={(e) => openAttach(form.values.wb1_stamping_certificate_attachment)} >View</Button.Ripple> */}
                      <Uploader isReadOnly ={true} label ={"Stamping Certificate 1"} selectedFileName={form.values.wb1_stamping_certificate_attachment}/>
                      </Col>
                ...
                <Row style={{paddingLeft:"15px"}}>
                    ...
                    {/* <p>Stamping Certificate 2</p>
                      ...
                      <Uploader isReadOnly ={true} label ={"Stamping Certificate 2"} selectedFileName={form.values.wb2_stamping_certificate_attachment}/>
                    </Col>
                </Row>  
                </div>      
                <div style={{border:"2px solid #7367f0 ",padding:"20px",borderRadius:"6px",marginTop:"20px"}}> 
           ...
           onChange={""}  />   */}
            ...
            <CustomTextInput form={form} label={"Heavy Vehicle Movement"} disabled
            ...
            <span id="inside_heavy_vehicle_mvmt_Error" style={{color: "red"}} ></span>
                    ...
                    <Col md="4" sm="12"> 
                    <CustomTextInput label={"No of Truck In Capacity"} form={form} id="inside_no_of_truck_in_capacity" disabled isNumberOnly  /> 
               ...
               <div style={{border:"2px solid #7367f0 ",padding:"20px",borderRadius:"6px",marginTop:"20px"}}> 
                ...
                <span id="statutory_survey_type_Error" style={{color: "red"}} ></span> 
                    ...
                    {/* <Button.Ripple color="primary" type="Button"
                    onClick={(e) => openAttach(form.values.statutory_type_attachment)} >View</Button.Ripple>  */}
                    <Uploader isReadOnly ={true} selectedFileName={form.values.statutory_type_attachment}/>
                    </Col>
                </Row>
                </div> 
                ...
                <Col md="4" sm="12"> 
                   ...
                   <div>   <Button.Ripple color="primary"  type="Button" id="license_copy_attachment1"
                   onClick={(e) => openAttach(form.values.license_copy_attachment1)}>View</Button.Ripple> </div>    */}
                   <Uploader isReadOnly ={true} label={"License Copy 1"} selectedFileName={form.values.license_copy_attachment1}/>
                   <span id="license_copy_attachment1_Error" style={{color: "red"}} ></span>
                
                    </Col>  
                    <Col md="4" sm="12"> 
                    {/* <Label>License Copy 2</Label>  
                    <div>    <Button.Ripple color="primary"  type="Button"  id="license_copy_attachment2"
                            onClick={(e) => openAttach(form.values.license_copy_attachment2)}>View</Button.Ripple> 
                    </div>  */}
                    <Uploader isReadOnly ={true} label={"License Copy 2"} selectedFileName={form.values.license_copy_attachment2}/>
                    <span id="license_copy_attachment2_Error" style={{color: "red"}} ></span>
               
                    </Col>      
                    <Col md="4" sm="12"> 
                    {/* <Label>License Copy 3</Label>  
                    <div> <Button.Ripple color="primary"  type="Button"  id="license_copy_attachment3"
                    onClick={(e) => openAttach(form.values.license_copy_attachment3)}>View</Button.Ripple> </div>  */}
                    <Uploader isReadOnly ={true} label={"License Copy 3"} selectedFileName={form.values.license_copy_attachment3}/>
...
const WarehouseApprovalData = ({isViewOnly,isViewAll})  => { 
  ...
  const onSubmit = () => { 
    ...
    return (
        <Fragment>
         <CardComponent  header="Warehouse WM Manager Approval">
