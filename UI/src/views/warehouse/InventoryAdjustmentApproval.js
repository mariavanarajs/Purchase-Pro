...
let Data={
 ...
 const updateInventoryAdjustmentApprove = () => {
  ...
  let fdata = {
    stockEntryformData,
   formType:"InventoryAdjustmentApproval",
  };
    ...
    return ( 
        ...
        <Row > 
            <Col md="3" sm="12">  
            <DatePicker form={form} label={"From Date"} id="Fromdate" isDateRange={false} />
            </Col>
            <Col md="3" sm="12">  
            
            <DatePicker form={form} id="Todate" label={"To Date"} isDateRange={false} />
            </Col>  
              <Col sm="12">
            ...
            <tbody  style={{textAlign:"center"}}>
                      ...
                      stockEntryformData.length>0 &&
                        ...
                        <tr>
                          ...
                          <td>
                            <Button.Ripple color="primary" type="Button" style={{bottomMargin:"5px"}} onClick={(e) => {DeleteItem(item.Physical_Inventory_Id,2);}}>Approve</Button.Ripple>
                            &nbsp;<Button.Ripple color="primary" type="Button" onClick={(e) => {DeleteItem(item.Physical_Inventory_Id, -1);}}>Reject</Button.Ripple>
                            </td>                        </tr>
                        )
...
const InventoryAdjustmentApprovalData = () => { 
  ...
  const onSubmit = () => { 
   ...
   Status:formData.Status,
    ...
    return(
        <Fragment>
        <CardComponent  header="Accounts Physical Inventory Adjustment Approval Screen">
