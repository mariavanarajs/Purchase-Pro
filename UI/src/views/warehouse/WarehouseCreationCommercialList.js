...
const WarehouseCreationCommercialList = () => {
  ...
  let title="Warehouse Creation - Commercial Team List";
  console.log(title);
  ...
  let actionRendorer=(row) => {
    ...
    let tx = "View";
          ...
          else if(row.approval_status==7 || row.approval_status==107)
          {
            tx="Commercial Entry";
          }
  ...
  return (
      ...
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="WarehouseCreationCommercialList" />
        </CardBody>
      </Card>
    </div>
    </Fragment>
