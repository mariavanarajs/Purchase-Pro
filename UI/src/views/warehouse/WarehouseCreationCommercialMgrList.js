...
const WarehouseCreationCommercialList = () => {
  
  let title="Warehouse Creation - Commercial Manager List";
  console.log(title);
  ...
  let actionRendorer=(row) => {
    ...
    let tx = "View";
          ...
          else if(row.approval_status==8 || row.approval_status==108) 
          {
            tx="Commercial Approve";
          }
      ...
      <Button.Ripple
        ...
        onClick={() => {
          ...
          {
            history.push(`/warehouse/wclcommmgrapprove:` + row.wh_refid );
          }
        }}
      >
        {tx}
  ...
  return (
      ...
      <Card>
        ...
        <CardBody>
          <TableComponent columns={columns} url={url} formType="WarehouseCreationCommMgrList" />
        </CardBody>
      </Card>
    </div>
    </Fragment>
...
export default WarehouseCreationCommercialList;
