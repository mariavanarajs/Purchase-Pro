...
const GatePassReceiptGateIn = ({ data, setData, setSelectedValue, setModuleType, getUnLoadingData, Unloading_Gate_in_Vehicle }) => {
...
export default GatePassReceiptGateIn