...
const CustomMillingTruckContainer = ({ }) => {
    ...
    const getGateInInfo = () => {  
        ...
        // } 
        showLoader();
        apiPostMethod(apiBaseUrl + `SupplierDispatch/getCustomMillingMiroDetailsByIdWheat`, requestData)  // Send as body, not in URL
            .then((response) => {
                const { data } = response;
...
export default CustomMillingTruckContainer;
