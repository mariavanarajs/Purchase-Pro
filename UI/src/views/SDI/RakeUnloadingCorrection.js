...
import RakeUnloadingChange from './RakeUnloadingChange';

const RakeUnloadingCorrection = () => {
    ...
    const getEmployeeDetails = (status) => {
        ...
        showLoader();
        apiGetMethod(apiBaseUrl + `RakeloadingController/SurveyorDetails/${status}/${fromDateMilliSecond}/${toDateMilliSecond}`)
            .then((response) => {
                const { data } = response;
    ...
    return (
        <>
            <Card>
            <CardHeader>Rake Unloading Surveyor Report</CardHeader>
                <hr></hr>
            <CardBody>
            ...
            <RakeUnloadingChange data={data} getEmployeeDetails={getEmployeeDetails} hide={hide}/>
            </CardBody>
            </Card>
        </>
...
export default RakeUnloadingCorrection