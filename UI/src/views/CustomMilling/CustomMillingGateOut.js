...
const CustomMillingGateOut = () => {
    ...
    return (
        <Fragment>
            <Card>
                <CardHeader><h5>Custom Milling - Gate Out</h5></CardHeader>
                <hr></hr>
                <CardBody>
                    <Row>
                        <Col md="4" sm="4">
                        ...
                        {data.subModuleTypeId == 30 &&
                        <Col md="4" sm="4">
                            <FormGroup>
                                <Label>Sub Module Type</Label>
                                <Input type="text" placeholder="Enter VA No" value={data.subModuleType} disabled />
                            </FormGroup>
                        </Col>}
                        <Col md="4" sm="4">
                            <FormGroup>
...
export default CustomMillingGateOut;
