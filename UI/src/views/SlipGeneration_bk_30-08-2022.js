      ...
      .then((response) => {
        ...
        if (data.success) {
          ...
          form.setValues({
            ...
            RGateOutDateTime: data.results[0].GateOutDt,
            RGateInDateTime: data.results[0].GateInDt,
...
{form.values.lotno1bag1 &&
<tr><td style={{ width: "13%" }}>Bag 1 :</td> <td style={{ width: "50%" }}>{form.values.lotno1bag1} ({form.values.lotno3bag1qty})</td></tr>}
