        ...
        <CardBody>
          ...
          <Row>
            ...
            <Col md="4" sm="12">
              ...
              <CustomTextInput label={"Port of loading"} form={form} id="portOfLoading" disabled />
            </Col>
            <Col md="4" sm="12">
             {/* <CustomDropdownInput label={"Stuffing Vendor"} url={`${masterUrl}?formType=StuffingVendor`} form={form} id="stuffingVendor" />*/}
              <CustomTextInput label={"Stuffing Vendor"} form={form} id="stuffingVendor" disabled />
            </Col>
            <Col md="4" sm="12">
              <CustomTextInput label={"Stuffing Rate/Ton"} form={form} id="stuffingRate" isNumberOnly disabled />
            ...
            <Col md="4" sm="12">
              ...
              />*/}
              <CustomTextInput label={"Yard to Freight Vendor"} form={form} id="yarToPortFrtVendor" disabled />
            </Col>
            <Col md="4" sm="12">
              <CustomTextInput label={"Yard to Port Rate Per Container"} disabled form={form} id="yardToPortRate" isNumberOnly />
            </Col>
            <Col md="4" sm="12">
             {/* <CustomDropdownInput label={"Fumigation Status"} options={fumigationOption} form={form} id="fumigation" />*/}
             <CustomTextInput label={"Fumigation Status"} form={form} id="fumigation" disabled />
            </Col>
            {values.fumigation && values.fumigation.value === "YES" && (
              <>
                <Col md="4" sm="12">
                  ...
                  />*/}
                   <CustomTextInput label={"Fumigation Vendor Name"} form={form} id="fumigationVendorName" disabled />
                </Col>
                <Col md="4" sm="12">
                  <CustomTextInput label={"Fumigation Rate Per Container"} disabled isNumberOnly form={form} id="fumigationRatePerC" />
                </Col>
              </>
            )}
            ...
            <Col md="4" sm="12">
             {/* <CustomDropdownInput label={"Liner Name"} url={`${masterUrl}?formType=LinerName`} form={form} id="linerName" />*/}
              <CustomTextInput label={"Liner Name"} form={form} id="linerName" disabled />
            </Col>
            <Col md="4" sm="12">
              <CustomTextInput label={"Ocean Freight"} form={form} id="linerOceanFrt" disabled />
            </Col>
            <Col md="4" sm="12">
            ...
            <Col md="4" sm="12">
              <CustomTextInput label={"WB Load Wt (In Kgs)"} form={form} id="wbLoadWt" disabled isNumberOnly />
            </Col>
            <Col md="4" sm="12">
            ...
            <Col md="4" sm="12">
              <CustomTextInput label={"Loading Date"}  disabled form={form} id="LDate" />
            </Col>
            <Col md="4" sm="12">
              <CustomTextInput label={"Seal No"} form={form} disabled id="serialNo" />
            </Col>
          </Row>
        </CardBody>
      </Card>
