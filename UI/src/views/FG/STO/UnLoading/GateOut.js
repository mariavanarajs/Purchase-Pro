...
const GateOut = () => {
    ...
    const getData = () => {
        console.log(apiBaseUrl + `warehouse/master/getwarehousewithID_ID/${id}`);
    ...
    const selectPlant = (e) => { setPlantValue([e]); }

    return (
        <Fragment>
            <CardComponent header="UnLoading - STO Gate Out">
                <hr></hr>
                <Fragment>
                    <Row>
                        {/* <Col md="4" sm="4">
                        ...
                        {data ?
                            <Col md="4" sm="4">
                                <FormGroup>
                                    <Label>VA No</Label>
                                    <Input type="number" placeholder="Enter VA No" value={route} disabled />
                                </FormGroup>
                            </Col> : null
                        }
                        {data ?
                        ...
                        {/* {showGeneralData ?
                            <Col md="4" sm="4">
                                <FormGroup>
                                    <Label>Order</Label>
                                    <Input type="text" placeholder="Enter Order" value={MobileNumber} disabled />
                                </FormGroup>
                            </Col> : null
                        }
                        {showGeneralData ?
                        ...
                        {data ? <Col md="8" sm="8" ></Col> : null}
                        {/* {showGeneralData ? <Col md="5" sm="5" ></Col> : null}
                        {showGeneralData ? <Col md="8" sm="8" ></Col> : null} */}
