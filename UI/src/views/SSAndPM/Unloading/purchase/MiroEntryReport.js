...
const MiroEntryReport = ({ actionRendorer }) => {
    ...
    apiPostMethod(
        `${apiBaseUrl}MigoAutomationController/MiroDetailReport/${fromDateMilliSecond}/${toDateMilliSecond}/${selectedModuleTypes}/${UserDetails.USERID}/${miroStatus}/${plantId}/${UserDetails.plantids}`
    )
        .then((response) => {
            const { data } = response;
                            ...
                            <FormGroup>
                                ...
                                <ReactSelect
                                    ...
                                    onChange={(selectedOptions) => {
                                        setModuleType(selectedOptions);
                                    }}
                                    value={moduleType}
                                    placeholder="Select PO Type(s)"
                                />
                            </FormGroup>
                        </Col>
                          <Col sm="3" md="3">
...
export default MiroEntryReport;
