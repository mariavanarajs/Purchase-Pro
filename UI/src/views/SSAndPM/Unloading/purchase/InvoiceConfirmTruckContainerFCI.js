...
const InvoiceConfirmTruckContainerFCI = ({ }) => {
    ...
    const AddDatasPO = () => {
        ...
        const filteredPoData = poData.filter(item => item.selected === true);
            ...
            console.log(filteredPoData[0].condition)
            console.log(uniqueInvoiceNos)
            if (uniqueInvoiceNos.size > 1 && filteredPoData[0].condition === "") {
            ...
            if (uniqueInvoiceDates.size > 1 && filteredPoData[0].condition === "") {
...
export default InvoiceConfirmTruckContainerFCI;
