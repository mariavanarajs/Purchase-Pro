                                ...
                                <tbody>
                                    <tr>
                                        <td style={{ padding: "5px" }}><table style={{ width: "100%" }} border={0}>
                                            ...
                                            <tr style={trstyle}>
                                                ...
                                                <td style={{ width: "23%" }}><strong>Vehicle No :</strong></td><td>{data.vehicleNo}</td>
                                                <td style={{ width: "13%" }}><strong>Driver Phone No :</strong></td><td style={{ width: "10%" }}>{data.driverMobileNumber}</td>
                                            </tr>
                                            ...
                                            <tr style={trstyle}>
                                                ...
                                                {/* {data.fromPlant ? <> <td><strong>Rec Plant :</strong></td><td>{data.fromPlant}</td> </> : null} */}
                                            </tr>
                                            ...
                                            {poData.map((poDetails) => (
                                                <tr style={trstyle} key={poDetails.poNumber}>
                                                    ...
                                                    <td><strong>PO Type {poDetails.sno} :</strong></td><td>{data.moduleTypeId == 6 ? 'Stores & Spares' : poDetails.name}</td>
                                            ...
                                            <tr style={trstyle}>
                                                <td><strong>Sending GateIn Date & Time :</strong></td><td>{data.fromPlantGateInDateStamp ? data.fromPlantGateInDateStamp : data.gateInDateStamp}</td>
                                                <td><strong>Sending GateOut Date & Time :</strong></td><td>{data.fromPlantGateOutDateStamp ? data.fromPlantGateOutDateStamp : data.gateOutDateStamp}</td>
                                            </tr>
                                            {data.fromPlantGateInDateStamp != null ?
                                                <tr style={trstyle}>
                                    ...
                                    <table style={{ width: "100%" }}>
                                        <div className='row' style={{ padding: "18px" }}>
                                            ...
                                            {data.secondWeight != null && data.fromPlantFirstWeight != "" && data.movementTypeId == 2 ?
...
export default SsAndPmSmartForm