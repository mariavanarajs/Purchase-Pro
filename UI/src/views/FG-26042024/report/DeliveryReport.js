...
const DeliveryReport = () => {
    ...
    const getDeliveryReport = () => {
        ...
        showLoader();
        console.log(apiBaseUrl + `GatePro/Report/getDeliveryReport/${fromDateMilliSecond}/${toDateMilliSecond}/${moduleType}/${userPlant}/${UserDetails.USERID}`)
        apiPostMethod(apiBaseUrl + `GatePro/Report/getDeliveryReport/${fromDateMilliSecond}/${toDateMilliSecond}/${moduleType}/${userPlant}/${UserDetails.USERID}`)
            .then((response) => {
                const { data } = response;
