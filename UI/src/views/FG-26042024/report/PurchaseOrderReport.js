...
const PurchaseOrderReport = () => {
    ...
    const getPurchaseOrderReport = () => {
        ...
        showLoader();
        console.log(apiBaseUrl + `GatePro/Report/getPurchaseOrderReport/${fromDateMilliSecond}/${toDateMilliSecond}/${moduleType}/${userPlant}/${UserDetails.USERID}`)
        apiPostMethod(apiBaseUrl + `GatePro/Report/getPurchaseOrderReport/${fromDateMilliSecond}/${toDateMilliSecond}/${moduleType}/${userPlant}/${UserDetails.USERID}`)
            .then((response) => {
                const { data } = response;
    ...
    //             const { data } = response;
    //             if (data.success == true) {
    //                 setData(data.results.filter((item) => item.moduleTypeId == 12 || item.moduleTypeId == 15 || item.moduleTypeId == 21))
    //             }
    //             else if (data.success == false) {
    //                 errorToast(data.message)
    //             }
