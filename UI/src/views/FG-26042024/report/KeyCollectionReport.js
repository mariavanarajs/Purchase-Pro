...
const KeyCollectionReport = () => {
    ...
    const getCashReportDetails = () => {
        ...
        showLoader();
        console.log(apiBaseUrl + `GatePro/Report/getKeyCollectionReport/${fromDateMilliSecond}/${toDateMilliSecond}/${userPlant}/${UserDetails.USERID}`)
        apiPostMethod(apiBaseUrl + `GatePro/Report/getKeyCollectionReport/${fromDateMilliSecond}/${toDateMilliSecond}/${userPlant}/${UserDetails.USERID}`)
            .then((response) => {
                const { data } = response;
