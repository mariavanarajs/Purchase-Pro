...
const GatePassReport = () => {
    ...
    const getPurchaseOrderReport = () => {
        ...
        showLoader();
        console.log(apiBaseUrl + `GatePro/Report/getGatePassReport/${fromDateMilliSecond}/${toDateMilliSecond}/${moduleType}/${userPlant}/${UserDetails.USERID}`)
        apiPostMethod(apiBaseUrl + `GatePro/Report/getGatePassReport/${fromDateMilliSecond}/${toDateMilliSecond}/${moduleType}/${userPlant}/${UserDetails.USERID}`)
            .then((response) => {
                const { data } = response;
