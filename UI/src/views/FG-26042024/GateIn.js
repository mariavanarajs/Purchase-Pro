                    ...
                    <Row>
                        <Col md="4" sm="4">
                            <FormGroup>
                                ...
                                <InputGroup>
                                    <Input type="text" name="Vehicle_Number" id="Vehicle_Number" placeholder="Truck No" onChange={selectTruckNo} value={truckValue} disabled={isDisable} maxLength={10} />
                        ...
                        {UserDetails.USERID != 1 ? <>
                            {data?.TRIPSHEET_NO != undefined && userGate?.isMovement == 1 && userGate.userGateId != 6 ?
                                <Col md="4" sm="12">
                                    <FormGroup>
                                        <Label>Movement Type</Label>
                        ...
                        {(shipmentOrderNo != '' || UserDetails.USERID == 1 || userGate.userGateId == 6) && (data.TRIPSHEET_NO != undefined && type != 17 && type != 18 && type != 2) ? <FGSales data={data} setData={setData} setTruckValue={setTruckValue} setShipmentOrderNo={setShipmentOrderNo} getLoadingData={getLoadingData} setIsDisable={setIsDisable} setShow={setShow} /> : null}
