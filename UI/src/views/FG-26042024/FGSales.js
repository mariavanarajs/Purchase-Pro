...
const FGSales = ({ data, setTruckValue, setShipmentOrderNo, getLoadingData, setIsDisable, setShow }) => {
    ...
    return (
        <Fragment>
            <Col md="4" sm="4">
                <FormGroup>
                    <CustomTextInput label={"Driver Phone No"} isNumberOnly form={form} id="driverNo" value={data.DRIVER_PHONE_NO} disabled />
                </FormGroup>
            </Col>
            ...
            {showGeneralData ? <>
                ...
                {data?.SAP_LINE[0]?.SHIPMENTORDERNO ?
                    <Col md="4" sm="4">
                        <FormGroup>
                            <Label>Shipment Order No</Label>
                            <Input type="text" placeholder="Enter Shipment Order No" disabled value={data?.SAP_LINE[0]?.SHIPMENTORDERNO} />
                        </FormGroup>
                    </Col> : null
                }
                <Col md="4" sm="4">
