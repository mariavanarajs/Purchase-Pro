...
const SDGSGateIn = ({ data, setData, setModuleTypeId, setTruckValue, setIsDisable, getLoadingData, setShow }) => {
    ...
    return (
        <>
            <Col md="4" sm="4" >
                <FormGroup>
                    <Label for="cityMulti">Type</Label>
