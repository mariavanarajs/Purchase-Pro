    ...
    <Row>
      ...
      <Col md="4" sm="4">
        <FormGroup>
          ...
          <Input type="text" placeholder="Enter From Plant Empty Weight" value={gateInOutData?.fromPlantFirstWeight} disabled />
        </FormGroup>
      </Col>
      ...
      <Col md="4" sm="4">
        <FormGroup>
          ...
          <Input type="text" placeholder="Enter From Plant Net Weight" value={Number(overAllWeight?.secondWeight - gateInOutData?.fromPlantFirstWeight)} disabled />
        </FormGroup>
      </Col>
      ...
      {gateInOutData.pickSlipCopy ?
        <Col sm="8" md="8">
          ...
          <FormGroup className="d-flex justify-content-start mb-0">
            ...
            <div className="mr-1">
              <a target="_blank" href={gateInOutData.pickSlipCopy}>
                <Button outline color="success" type="button">
                  Pick Slip Copy
                </Button>
              </a>
