...
const SDGStoGateOut = () => {
    ...
    const [attachedFiles, setAttachment] = useState({ sendingWBSlip: {} });
        ...
        if (keys.length > 0) {
            ...
            apiPostMethod(sapFileShare, postdata, "File")
                .then((response) => {
                    const { data } = response;
                    if (data.success) {
                        fdata.sendingWBSlip = data.files[0] ? data.files[0].updname : "";
                        ...
                        <Row>
                            ...
                            {/* <Col md="4" sm="4">
                                <FormGroup>
                                    ...
                                    <Input type="text" placeholder="Enter Sending Plant" disabled />
                                </FormGroup>
                            </Col>
                            <Col md="4" sm="4">
                                <FormGroup>
                                    <Label>Material Name</Label>
                                    <Input typr="text" placeholder="Enter Material Name" disabled />
                                </FormGroup>
                            </Col>
                            <Col md="4" sm="4">
                                <FormGroup>
                                    <Label>STO PO</Label>
                                    <Input typr="text" placeholder="Enter STO PO" disabled />
                                </FormGroup>
                            </Col>
                            <Col md="4" sm="4">
                                <FormGroup>
