...
const LoadUnloadPaymentACCConfirm = ({})  => { 
 ...
 //Modal pop up window 
   ...
   const [Data, setData] = useState([]);
    ...
    const Approve=(status)=>{
      ...
      if(status == 8 && (postdata.remarks == '' || postdata.remarks == undefined) ){
       errorToast("Please Enter Remarks...");
       return false;
     }else if(status == 3 && (postdata.miro_posting_date == '' || postdata.miro_posting_date == undefined) ){
    ...
    const dateRestriction_invoice = DateComponent('invoice')

  return ( 
    <Fragment>
    <RefreshBlock/>
     {/* <div style={{ border: "2px solid #7367f0 ", padding: "2px", borderRadius: "6px", marginTop: "1px" }}> */}
     <CardComponent  header="Loading & Unloading Payment Confirmation - Accounts Executive">
      ...
      <Modal show={open} centered size="xl">
        <Modal.Header><b>Accounts Executive Confirmation</b>
            ...
            <Modal.Body>
                <Row>
                    ...
                    <Col md="4" sm="12">
                      ...
                      min={dateRestriction_invoice.min_date} 
                      max={dateRestriction_invoice.max_date} />
                ...
                <Row>
                  <Col align="left">
                    <Button onClick={(e) => Approve(8)} color="danger">Reject</Button>
                  </Col>
                  <Col align="right">
...
export default LoadUnloadPaymentACCConfirm 
