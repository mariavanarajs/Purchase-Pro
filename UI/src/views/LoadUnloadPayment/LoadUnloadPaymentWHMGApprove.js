...
const LoadUnloadPaymentWHMGApprove = ({})  => { 
 ...
 //Modal pop up window 
  ...
  return ( 
    ...
    <RefreshBlock/>
     ...
     <CardComponent  header="Loading & Unloading Payment Approval - Warehouse Manger">
      ...
      <Modal show={open} centered size="xl">
        <Modal.Header><b>Warehouse Manager Approval</b>
...
export default LoadUnloadPaymentWHMGApprove 
