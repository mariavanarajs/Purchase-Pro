...
const Routes = [
  ...
  // {
  //   path: "/EVADPview/:fromPage?/:emptyArrivalId?",
  //   component: lazy(() => import("../../views/IAS/sending/gate-out/ias-trailer-gate-out-screen")),
  // },
  {
    path: "/EVADPTruck",
  ...
  // {
  //   path: "/EVADPTruckView/:fromPage?/:emptyArrivalId?",
  //   component: lazy(() => import("../../views/IAS/sending/gate-out/ias-truck-gate-out-screen")),
  // },
  {
  ...
  // {
  //   path: "/IASUL/:type?/:emptyArrivalId?/:receivingArrivalId?",
  //   component: lazy(() => import("../../views/IAS/receiving/ias-warehouse-incharge")),
  // },
  // {
  //   path: "/IASRGO/:type?/:emptyArrivalId?/:receivingArrivalId?",
  //   component: lazy(() => import("../../views/IAS/receiving/receiving-gate-out")),
  // },
  {
    path: "/IASSWI",
  ...
  // {
  //   path: "/IASLoadingRedirect/:type?/:fromPage?/:emptyArrivalId?",
  //   component: lazy(() => import("../../views/IAS/sending/ias-sending-redirect")),
  // },
  {
...
/*  {
    path: "/master/master_bag",
    component: lazy(() => import("../../views/master/Masterbagentry")),
  },
  
  {
    path: "/master/master_bag:id",
    component: lazy(() => import("../../views/master/Masterbagentry")),
  },
  */
  {
